...
if(isset($_COOKIE["cart"])){
  $cartNav = json_decode($_COOKIE["cart"]);
  $numberOfItems = count($cartNav);
}
?>
  ...
  <div class="navbar-collapse collapse" id="navbarNav">
    <ul class="navbar-nav mr-auto">
        ...
        <li id="adminShop"class="nav-item">
            <a class="nav-link" href="admin/adminShop.php">Admin</a>
        </li>
        <?php
              }
            }
    ...
    <li id="cartNav"class="nav-item">
      <a class="nav-link" href="cart.php"><?php if(isset($numberOfItems) && $numberOfItems > 0)echo $numberOfItems."&nbsp&nbsp"?><i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
    </li>
