...
/* 
 * Load function based on the POST request
 */ 
    ...
    <main class="calendar-contain"> 
        ...
        <section class="calendar__days"> 
            <section class="calendar__top-bar"> 
                <span class="top-bar__days text-white">Mon</span> 
                <span class="top-bar__days text-white">Tue</span> 
                <span class="top-bar__days text-white">Wed</span> 
                <span class="top-bar__days text-white">Thu</span> 
                <span class="top-bar__days text-white">Fri</span> 
                <span class="top-bar__days text-white">Sat</span> 
                <span class="top-bar__days text-white">Sun</span> 
            </section> 
